...
<head>
  ...
  <meta name="keywords" content="Induz Responsive web template, Bootstrap Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
  <title>GiftHeart an Industrial Category Bootstrap Responsive Web Template | Home :: W3Layouts </title>
  <link href="//fonts.googleapis.com/css2?family=Roboto:ital,wght@0,400;0,500;0,700;0,900;1,400&display=swap" rel="stylesheet">
  <!-- Template CSS -->
        ...
        <nav class="navbar navbar-expand-lg stroke">
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav mx-lg-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="viewshop.php">Shops</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="chat.php">Feedback</a>
              </li>
              <li class="nav-item">
    ...
    <div class="w3l-banner-content">
      <div class="container">
        <div class="bannerhny-info text-center">
          <h3 class="">The greatest gift of life is friendship, and I have received it.
          </h3>
    ...
    <div class="container">
      <div class="row upper-sec-grids">
        <div class="col-lg-7 upper-sec-grids-left pr-lg-5">
          ...
          <h3 class="title-w3l mb-3">GiftHeart.</h3>
    ...
    <div class="container py-lg-5 py-md-3">
      <div class="row">
        ...
        <div class="col-lg-6 mt-lg-0 mt-5 align-self pl-lg-5">
          ...
          <a class="btn btn-style btn-primary mt-sm-5 mt-4" href="about.html"> Read More <span class="fa fa-angle-double-right ml-2" aria-hidden="true"></span></a>
        </div>
      ...
      <div class="row w3l-content-inf">
        ...
        <div class="col-lg-6 w3l-content-right pl-lg-5 mt-lg-0 mt-5">
          ...
          <div class="progress-info info2 mb-4">
            <h6 class="progress-tittle">Working Quality <span class="">75%</span>
            </h6>
            <div class="progress">
          ...
          <div class="progress-info info3 mb-4">
            <h6 class="progress-tittle">Fastest Delivery <span class="">85%</span></h6>
            <div class="progress">
              <div class="progress-bar progress-bar-striped" role="progressbar" style="width:85%" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">
              </div>
            </div>
          </div>
          <div class="progress-info info3 mb-4">
            <h6 class="progress-tittle">Offers <span class="">90%</span></h6>
            <div class="progress">
    ...
    <div class=" container py-lg-5 py-3">
      <div class="row w3l-stats-content-grids">
        ...
        <div class="col-lg-6 w3l-stats-content-grid-right">
          <img style="width:500px;height:400px;" src="assets/images/g3.jpg" alt="" class="radius-image img-fluid">
          <img style="width:500px;height:400px;" src="assets/images/g4.jpg" alt="" class="radius-image img-fluid mt-4">
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="welcome-left">
        ...
        <div class="buttons mt-md-5 mt-4">
          <a class="btn btn-style btn-white mr-3" href="about.html">
            Read More <span class="fa fa-angle-double-right ml-2" aria-hidden="true"></span></a>
          <a class="btn btn-style btn-primary" href="about.html"> Get a quote <span class="fa fa-angle-double-right ml-2" aria-hidden="true"></span></a>
    ...
    <div class="container">
      <div class="row footer-top-28">
        <div class="col-lg-5 footer-list-28 pr-lg-5 mt-5">
          <h6 class="footer-title-28">GiftHeart</h6>
      ...
      <div class="midd-footer-28 align-center py-2 mt-5">
        <p class="copy-footer-28 text-center">© 2021 Induz. All rights reserved. Design by <a href="https://w3layouts.com/" target="_blank">
            W3layouts</a></p>
      </div>
    </div>
